...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "display": ["5rem", { lineHeight: "1.05", letterSpacing: "-0.03em", fontWeight: "600" }],
        "h1": ["3.75rem", { lineHeight: "1.08", letterSpacing: "-0.025em", fontWeight: "600" }],
        "h2": ["2.75rem", { lineHeight: "1.1", letterSpacing: "-0.02em", fontWeight: "600" }],
        "h3": ["2rem", { lineHeight: "1.2", letterSpacing: "-0.015em", fontWeight: "600" }],

...
export function HowItWorksSection() {
  ...
  return (
    <Section id="how-it-works" spacing="xl" className="relative px-4 md:px-0">
      {/* Background accent */}
      <div className="absolute top-1/2 right-0 w-64 md:w-96 h-64 md:h-96 bg-accent/10 rounded-full blur-[128px] -translate-y-1/2" />
            ...
            <div key={step.number} className="relative">
              ...
              >
                ...
                <div className="pt-6 md:pt-8 space-y-3 md:space-y-4">
                  ...
                  <p className="text-xs md:text-body text-muted-foreground leading-relaxed">{step.description}</p>
                </div>
              </GlassCard>
            </div>
          ))}

  ...
  return (
    <Section id="security" spacing="xl" className="relative">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-primary/5 rounded-full blur-[100px]" />
      </div>
      ...
      <GlassCard variant="glow" size="xl" className="relative overflow-hidden p-4 md:p-8">
        ...
        <div className="text-center mb-6 md:mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-green-500/10 border border-green-500/20 text-green-600 text-xs md:text-sm font-medium mb-4 md:mb-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
          {securityFeatures.map((feature) => (
            <div
              key={feature.title}
              className="p-3 md:p-6 rounded-xl md:rounded-2xl bg-muted/50 border border-border hover:border-green-500/30 transition-colors group"
            >
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-green-500/20 flex items-center justify-center mb-2 md:mb-4 group-hover:bg-green-500/30 transition-colors">
                <feature.icon className="w-5 h-5 md:w-6 md:h-6 text-green-600" />
              </div>

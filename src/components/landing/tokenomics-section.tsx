...
export function TokenomicsSection() {
  ...
  return (
    <Section id="tokenomics" spacing="xl" className="relative px-4 md:px-0">
      {/* Background */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-0 left-1/4 w-64 md:w-96 h-64 md:h-96 bg-primary/10 rounded-full blur-[128px]" />
        <div className="absolute top-0 right-1/4 w-64 md:w-96 h-64 md:h-96 bg-accent/10 rounded-full blur-[128px]" />
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
        ...
        <div className="space-y-4 md:space-y-6 order-1 lg:order-2">
          ...
          <GlassCard variant="subtle" size="default" className="p-4 md:p-6">
            <div className="space-y-3 md:space-y-4">
              <h4 className="text-base md:text-lg font-semibold text-foreground">{t("tokenomics.distribution")}</h4>
